...
.write.SED.hdf5=function(SED, filename='temp.hdf5', overwrite=FALSE, filters=c('FUV', 'NUV', 'u_SDSS', 'g_SDSS', 'r_SDSS', 'i_SDSS', 'Z_VISTA', 'Y_VISTA', 'J_VISTA', 'H_VISTA', 'K_VISTA', 'W1', 'W2', 'W3', 'W4', 'P100', 'P160', 'S250', 'S350', 'S500')){
  ...
  write.custom.dataset(filename=filename, group="SED/ab_nodust", object=SED[,1+colrun, drop=FALSE], dataset.name='bulge_d', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ab_nodust", object=SED[,1+colrun+Ncol, drop=FALSE], dataset.name='bulge_m', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ab_nodust", object=SED[,1+colrun+Ncol*2, drop=FALSE], dataset.name='bulge_t', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ab_nodust", object=SED[,1+colrun+Ncol*3, drop=FALSE], dataset.name='disk', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ab_nodust", object=SED[,1+colrun+Ncol*4, drop=FALSE], dataset.name='total', overwrite=overwrite)

  write.custom.dataset(filename=filename, group="SED/ap_nodust", object=SED[,1+colrun+Ncol*5, drop=FALSE], dataset.name='bulge_d', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ap_nodust", object=SED[,1+colrun+Ncol*6, drop=FALSE], dataset.name='bulge_m', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ap_nodust", object=SED[,1+colrun+Ncol*7, drop=FALSE], dataset.name='bulge_t', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ap_nodust", object=SED[,1+colrun+Ncol*8, drop=FALSE], dataset.name='disk', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ap_nodust", object=SED[,1+colrun+Ncol*9, drop=FALSE], dataset.name='total', overwrite=overwrite)

  write.custom.dataset(filename=filename, group="SED/ab_dust", object=SED[,1+colrun+Ncol*10, drop=FALSE], dataset.name='bulge_d', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ab_dust", object=SED[,1+colrun+Ncol*11, drop=FALSE], dataset.name='bulge_m', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ab_dust", object=SED[,1+colrun+Ncol*12, drop=FALSE], dataset.name='bulge_t', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ab_dust", object=SED[,1+colrun+Ncol*13, drop=FALSE], dataset.name='disk', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ab_dust", object=SED[,1+colrun+Ncol*14, drop=FALSE], dataset.name='total', overwrite=overwrite)

  write.custom.dataset(filename=filename, group="SED/ap_dust", object=SED[,1+colrun+Ncol*15, drop=FALSE], dataset.name='bulge_d', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ap_dust", object=SED[,1+colrun+Ncol*16, drop=FALSE], dataset.name='bulge_m', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ap_dust", object=SED[,1+colrun+Ncol*17, drop=FALSE], dataset.name='bulge_t', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ap_dust", object=SED[,1+colrun+Ncol*18, drop=FALSE], dataset.name='disk', overwrite=overwrite)
  write.custom.dataset(filename=filename, group="SED/ap_dust", object=SED[,1+colrun+Ncol*19, drop=FALSE], dataset.name='total', overwrite=overwrite)
